      ...
      {showAvatarPicker && (
        ...
        >
          ...
          >
            ...
            {/* Avatar Grid */}
            <div className="hide-scrollbar" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '12px', marginBottom: '20px', maxHeight: '280px', overflowY: 'auto', padding: '4px' }}>
